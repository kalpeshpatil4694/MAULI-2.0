...
const DEFAULT_AGENTS=[['SK Executive','Executive','Executive',['planning','governance','delegation'],[]],['Research Agent','Research','Research',['research','analysis'],['web.search']],['Product Agent','Product','Business',['requirements','product-planning','planning'],['planning.execute']],['Planning Agent','Planner','Planning',['product-planning','planning'],['planning.execute']],['Frontend Agent','Engineer','Engineering',['frontend','javascript','ui'],['code.execute','test.run']],['Backend Agent','Engineer','Engineering',['backend','api','javascript'],['code.execute','test.run']],['Database Agent','Engineer','Engineering',['database','schema','sql'],['database.query','code.execute']],['Security Agent','Reviewer','Security',['security','audit'],['security.scan']],['QA Agent','Tester','Quality',['testing','verification'],['test.run','code.execute']]];
